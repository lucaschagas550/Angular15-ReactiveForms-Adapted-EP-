...
import { ImageFormaterPiper } from './image.pipe';
...
export class FilmesComponent implements OnInit {
  ...
  constructor(private ImageFormaterPiper: ImageFormaterPiper) { }
  ...
  ngOnInit() {
    ...
    this.mapped = this.filmes.map(filme => {
      return {
        ...
        imagem: this.ImageFormaterPiper.transform(filme.imagem, 'default', true),
      }
    });
